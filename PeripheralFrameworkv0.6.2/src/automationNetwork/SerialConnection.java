...
import automationNetwork.ByteArrayHelpers.ByteArrayMode;
...
public class SerialConnection
{
	...
	public boolean writeBytes(byte[] bytes)
	{
		...
		{
			if (DEBUG_SERIAL) {
				System.out.println("Network Sending: " + ByteArrayHelpers.getByteArrayString(bytes, ByteArrayMode.BYTE_ARRAY_MODE_HEX));
			}
